...
?>
<div class="flex flex-row items-center w-full h-full bg-[url('../assets/background-login.jpg')] lg:bg-none bg-cover bg-center justify-center">
    <div class="lg:w-1/2 sm:w-1/2 lg:flex hidden bg-black h-full">
        <img class="h-full w-full" src="../assets/background-login.jpg" />
    </div>
